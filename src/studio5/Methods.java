...
public class Methods {
	...
	/**
	 * Return the mean value of the sum of integer values in an array
	 * 
	 * 
	 * @param values, array containing integers
	 * @return mean of integer values in the array
	 */
	
	public static double arrayMean(int[] values) {
		double mean = 0.0;
		double temp1 = values.length;
		double temp2 = arraySum(values);
		mean = temp2/temp1;
		return mean;
	}
